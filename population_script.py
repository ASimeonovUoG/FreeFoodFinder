...
def populate():
    ...
    for owner_data in owners:
        u = User.objects.get_or_create(email=owner_data['email'], first_name=owner_data['first_name'],
                                       last_name=owner_data['last_name'])[0]
    ...
    Offer.objects.get_or_create(business=Business.objects.get(businessName="Bath Street Burgers"), portionAmount=51)[
        0].save()
    Offer.objects.get_or_create(business=Business.objects.get(businessName="Trevi Italian Cuisine"), portionAmount=100)[
        0].save()
    Offer.objects.get_or_create(business=Business.objects.get(businessName="West End Bakery"), portionAmount=20)[
        0].save()
