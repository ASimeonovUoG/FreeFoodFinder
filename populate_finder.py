...
def populate():
    owners = [{
            'username': "trevi_italian@gmail.com",
            'first_name': "Antonio",
            'last_name': "Trevi",
            'password': "Password123"
        },
        {
            'username': "alberta.stevenson@googlemail.com",
            'first_name': "Alberta",
            'last_name': "Stevenson",
            'password': "123Password"
        },
        {
            'username': "flora.smith@outlook.com",
            'first_name': "Flora",
            'last_name': "Smith",
            'password': "MyPassword123"
        },
        {
            'username': "jonanthan.harding@gmail.com",
            'first_name': "Jonathan",
            'last_name': "Harding",
    ...
    users = [{
        ...
        {
            'username': "kerry.johnstone@googlemail.com",
            'password': "mypassword123"
        }
        ]
